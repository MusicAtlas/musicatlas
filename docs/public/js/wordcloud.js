...
WordCloud.prototype.draw = function(data, bounds) {
    ...
    text.style("font-family", function(d) {
        ...
        .on("click",function(d){
            ...
            var req  = "//db03.cs.utah.edu:8181/api/country_track_year_range_length_artist/"+self.country+"/"+self.start_year+"/"+self.end_year+"/"+self.min_length+"/"+self.max_length+"/"+artist_name+"?limit=200";
